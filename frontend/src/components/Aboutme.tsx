...
const Aboutme = (): JSX.Element => {
  return (
        <div className="h-screen bg-[#01313f]" id="about-me">
            ...
            <div className="flex flex-col md:flex-row justify-around items-center h-100% ease-in-out">
                {/* my cartoon photo with blob effect */}
                {/* adjusted size for mobile responsiveness until 1024px */}
                <div className="flex w-[50%] justify-center">
                    <img src={me} className="object-cover w-[150px] h-[150px] xxs:w-[195px] xxs:h-[195px] md:w-[250px] md:h-[250px] lg:w-[300px] lg:h-[300px] xl:w-[375px] xl:h-[375px] overflow-hidden rounded-[42%_56%_72%_28%_/_42%_42%_56%_48%] animate-blob-smooth shadow-blob-shadow ease-in-out"/>
                </div>
                {/* description about me */}
                <div className="flex justify-center ml-7 mr-7 md:w-[50%]">
                    <h1 className="text-white text-xs xxs:text-[2vh] xxs:leading-[2.5vh] sm:text-base md:text-xl mt-7 lg:mt-0 lg:text-2xl md:mr-[7vw] ease-in-out">
